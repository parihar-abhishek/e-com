...
const CartItem = () => {
  return <>
    <div className="flex items-center justify-between w-full px-5 bg-amber-400">
        <div className="flex items-center gap-5">
          ...
          <div className="grid items-center gap-4">
            <div className="grid items-center leading-none">
              ...
              <p className="text-sm text-slate-800 lg:text-xs">desc</p>
            </div>
            <div className="flex items-center justify-around w-full">
              <button
                type="button"
                onClick=""
                className="bg-black rounded  w-6 h-6 lg:w-5 lg:h-5 flex items-center justify-center active:scale-90"
              >
                <MinusIcon className="w-5 h-5 lg:w-4 lg:h-4 text-white stroke-[2]" />
              </button>
              <div className="bg-black rounded text-white font-medium lg:text-xs w-7 h-6 lg:h-5 lg:w-6 flex items-center justify-center">
               q
              </div>
              <button
                type="button"
